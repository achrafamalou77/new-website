...
const hiddenTemplateIds = new Set([
  'ecommerce-noir-luxe',
  'ecommerce-bloom-fresh',
  'ecommerce-titan-bold',
  'ecommerce-terra-earth',
  'ecommerce-neon-pulse',
])
...
export const templatesList: WebsiteTemplate[] = ([
  ...showroomTemplatesList,
  {
    id: 't-traventure-fr',
    name: 'Traventure FR',
    description: 'Template moderne en français avec hero éditorial, recherche rapide, voyages et visas détaillés.',
      ...
      sections: [
        {
          ...
          content: {
            ...
            subtitle: 'Voyages organisés, assistance visa et service premium.',
            primary_cta: 'Rechercher'
          },
          styles: {
            bg_type: 'solid',
            bg_color: '#f1f5f9',
        ...
        },
        {
          ...
          content: {
            title: 'Nos Voyages',
            subtitle: 'Catalogue complet des voyages disponibles'
          },
          styles: {
            bg_type: 'solid',
            bg_color: '#ffffff',
        ...
        },
        {
          ...
          content: {
            title: 'Services Visa',
            subtitle: 'Délais, coûts et conditions en toute transparence'
          },
          styles: {
            bg_type: 'solid',
            bg_color: '#ffffff',
  ...
  {
    id: 't-indonesia-charm',
    name: 'Indonesia Charm',
    description: 'Design ultra-moderne inspiré des plus beaux circuits d\'Indonésie. Hero immersif, galerie bento-grid, témoignages et blog photos.',
    thumbnail_url: 'https://images.unsplash.com/photo-1537996194471-e657df975ab4?w=600',
    category: 'premium',
    is_default: true,
    is_custom: false,
    business_type_slug: 'travel',
      ...
      sections: [
        {
          ...
          variant: 'indonesia',
          content: {
            title: 'Charme naturel et culturel extraordinaire',
            subtitle: 'Explorer le monde est une aventure inoubliable, profitez de la richesse des cultures et de la convivialité des locaux.',
            primary_cta: 'Rechercher'
          },
          styles: { bg_type: 'solid', bg_color: '#ffffff', text_color: '#1f2937', padding_top: 24, padding_bottom: 24, animation: 'fade' },
          visibility: { desktop: true, mobile: true }
        },
        {
          id: 'gallery-indonesia',
          type: 'Gallery',
          variant: 'indonesia-bento',
          content: {
            title: 'Destinations de Rêve',
            subtitle: 'La beauté naturelle extraordinaire et la richesse culturelle à travers le monde.'
          },
          styles: { bg_type: 'solid', bg_color: '#ffffff', text_color: '#1f2937', padding_top: 16, padding_bottom: 16, animation: 'fade' },
          visibility: { desktop: true, mobile: true }
        },
        {
          id: 'benefits-indonesia',
          type: 'WhyUs',
          variant: 'indonesia-benefits',
          content: {
            title: 'En un clic',
            subtitle: 'Nous vous offrons les meilleurs forfaits de voyage et des services premium.'
          },
          styles: { bg_type: 'solid', bg_color: '#ffffff', text_color: '#1f2937', padding_top: 16, padding_bottom: 16, animation: 'fade' },
          visibility: { desktop: true, mobile: true }
        },
        {
          id: 'trips-indonesia',
          type: 'Trips',
          variant: 'indonesia-trips',
          content: {
            title: 'Nos destinations de voyage',
            subtitle: 'Nos destinations offrent un mélange rare de beauté naturelle et de richesses culturelles.'
          },
          styles: { bg_type: 'solid', bg_color: '#ffffff', text_color: '#1f2937', padding_top: 16, padding_bottom: 16, animation: 'fade' },
          visibility: { desktop: true, mobile: true }
        },
        {
          id: 'testimonials-indonesia',
          type: 'Testimonials',
          variant: 'indonesia-quote',
          content: {
            title: 'Ce que disent nos voyageurs'
          },
          styles: { bg_type: 'solid', bg_color: '#ffffff', text_color: '#1f2937', padding_top: 16, padding_bottom: 16, animation: 'fade' },
        ...
        },
        {
          id: 'blog-indonesia',
          type: 'Blog',
          variant: 'indonesia-memories',
          content: {
            title: 'Nos souvenirs de voyage',
            subtitle: 'Découvrez nos derniers articles et récits de voyage.'
          },
          styles: { bg_type: 'solid', bg_color: '#ffffff', text_color: '#1f2937', padding_top: 16, padding_bottom: 16, animation: 'fade' },
          visibility: { desktop: true, mobile: true }
        }
  ...
  // ─── ECOMMERCE STORE THEMES ──────────────────────────────────────────────────

  {
    id: 'ecommerce-noir-luxe',
    name: 'Noir Luxe',
    description: 'Boutique ultra-premium en mode sombre avec accents dorés. Parfait pour les produits de luxe, mode haut de gamme et cosmétiques premium.',
    thumbnail_url: 'https://images.unsplash.com/photo-1441984904996-e0b6ba687e04?w=600',
    category: 'Boutique Premium',
    tags: ['luxe', 'mode', 'premium', 'dark', 'gold'],
    preview_url: '',
    is_premium: true,
    is_default: false,
    is_custom: false,
    business_type_slug: 'ecommerce',
    store_theme: 'noir-luxe',
    global_styles: {
    ...
    structure: { sections: generateDefaultSections('Noir Luxe') }
  },

  {
    id: 'ecommerce-bloom-fresh',
    name: 'Bloom Fresh',
    description: 'Boutique lifestyle pastel avec tons rose et vert sauge. Idéale pour beauté, bien-être, et produits féminins ou lifestyle.',
    thumbnail_url: 'https://images.unsplash.com/photo-1487754180451-c456f719a1fc?w=600',
    category: 'Boutique Lifestyle',
    tags: ['beauté', 'pastel', 'lifestyle', 'rose', 'féminin'],
    preview_url: '',
    is_premium: false,
    is_default: false,
    is_custom: false,
    business_type_slug: 'ecommerce',
    store_theme: 'bloom-fresh',
    global_styles: {
    ...
    structure: { sections: generateDefaultSections('Bloom Fresh') }
  },

  {
    id: 'ecommerce-titan-bold',
    name: 'Titan Bold',
    description: 'Boutique haute énergie en bleu électrique avec effets de lueur. Parfaite pour sport, tech, gaming et produits masculins.',
    thumbnail_url: 'https://images.unsplash.com/photo-1607082348824-0a96f2a4b9da?w=600',
    category: 'Boutique Sport & Tech',
    tags: ['sport', 'tech', 'bleu', 'bold', 'gaming'],
    preview_url: '',
    is_premium: false,
    is_default: false,
    is_custom: false,
    business_type_slug: 'ecommerce',
    store_theme: 'titan-bold',
    global_styles: {
      primary_color: '#2563eb',
    ...
    structure: { sections: generateDefaultSections('Titan Bold') }
  },

  {
    id: 'ecommerce-terra-earth',
    name: 'Terra Earth',
    description: 'Boutique naturelle et artisanale avec tons chauds beige et terracotta. Idéale pour produits bio, naturels et du terroir algérien.',
    thumbnail_url: 'https://images.unsplash.com/photo-1445116572660-236099ec97a0?w=600',
    category: 'Boutique Naturelle',
    tags: ['naturel', 'bio', 'terroir', 'artisanal', 'chaud'],
    preview_url: '',
    is_premium: false,
    is_default: false,
    is_custom: false,
    business_type_slug: 'ecommerce',
    store_theme: 'terra-earth',
    global_styles: {
      primary_color: '#c2560e',
      secondary_color: '#d4761e',
      accent_color: '#4a6741',
      text_color: '#3a1e0a',
      bg_color: '#f5f0e8',
      card_bg_color: '#ffffff',
    ...
    structure: { sections: generateDefaultSections('Terra Earth') }
  },

  {
    id: 'ecommerce-neon-pulse',
    name: 'Neon Pulse',
    description: 'Boutique Gen-Z avec néon cyan/violet et effets lumineux. Parfaite pour streetwear, électronique, gaming et produits tendance.',
    thumbnail_url: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=600',
    category: 'Boutique Tendance',
    tags: ['neon', 'streetwear', 'gen-z', 'gaming', 'cyber'],
    preview_url: '',
    is_premium: true,
    is_default: false,
    is_custom: false,
    business_type_slug: 'ecommerce',
    store_theme: 'neon-pulse',
    global_styles: {
      primary_color: '#06d6d6',
      secondary_color: '#a855f7',
      accent_color: '#ec4899',
      text_color: '#e2e8ff',
      bg_color: '#08080e',
      card_bg_color: '#0f0f1a',
      border_color: '#16162a',
      heading_font: 'Inter',
      body_font: 'Inter',
      base_font_size: 14,
    ...
    structure: { sections: generateDefaultSections('Neon Pulse') }
  }
] as WebsiteTemplate[]).filter((template) => !hiddenTemplateIds.has(template.id));
